                ...
                <div>
                    ...
                    >
                        <ul className="items-center justify-center mt-2 space-y-8 md:flex md:space-x-6 md:space-y-0">
                            ...
                            <li>
                            <Link className=" font-medium text-lime-100 hover:text-blue-300 mr-8" to="/about" onClick={() => {setNavbar(false)}}>FAQ</Link>
                            </li>
                            <div>
                            <Link to="/login" ><button className=" relative inline-flex items-center justify-center p-0.5   overflow-hidden text-sm font-medium text-white rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-teal-300 group-hover:to-lime-300 hover:text-black focus:ring-1 focus:outline-none focus:ring-lime-200 ">
                            <span className="relative px-3 py-1.5 transition-all ease-in duration-75 bg-sky-950  rounded-md group-hover:bg-opacity-0">
                            Log In
                            </span>
                            </button></Link>
                            <Link to="/register" ><button className="ml-4 text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-1 focus:outline-none focus:ring-lime-200  font-medium rounded-lg text-sm px-3 py-2 text-center ">Register</button></Link>
                            </div>

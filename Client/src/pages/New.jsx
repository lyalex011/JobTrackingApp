        ...
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
              <label htmlFor="priority" className="block mb-2 text-sm font-medium text-gray-900">Choose a priority level</label>
<select value={option} onChange={handleChange} id="priority" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 ">
  ...
  <option value={3}>Low</option>
          ...
          <label className="inline-flex items-center ">
            <input
              ...
              ref={checkboxRef}
            />
            <span className="ml-2 text-gray-700">Interview is scheduled</span>
          </label>
          </div>
          {showInput && (
            <>
          ...
          <div className="sm:col-span-3">
          <label htmlFor="priority" className="block mb-2 text-sm font-medium text-gray-900">Choose type of interview</label>
<select ref={intTypeRef} id="priority" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full p-2.5 ">
<option value="Phone screen">Phone screen</option>
<option value="Hiring manager interview">Hiring manager interview</option>
<option  value="Behavioral interview ">Behavioral interview </option>
<option value="Second or panel interview ">Second or panel interview</option>

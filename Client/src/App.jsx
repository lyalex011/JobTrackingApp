      ...
      <BrowserRouter>
        <div className="flex flex-col justify-between h-screen">
          ...
          <Routes>
            <Route
              path="/"
              element={<Welcome user={loggedIn_id} setUser={setUser} />}
            />
            <Route
              path="/faq"
              element={<FaqPage />}
            ...
            <Route
              path="/showinterview/:authorId/:id"
              element={<ShowInterview />}
            />
            <Route
              path="/newwithinterview"
              element={<NewWithInterview user={loggedIn_id} />}
            />
            <Route
              path="/additem"
              element={<NewWishlistItem user={loggedIn_id} />}
            />
            <Route
              path="/index/:authorId"
              element={<Index user={loggedIn_id} />}
            />

...
function EditProfile({user}) {
  ...
  return (
        ...
        <div className="max-w-sm mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
          <div className="border-b px-4 pb-6">
            <div className="text-center my-4">
              ...
              />
              <div className="py-2">
                <h3 className="font-bold text-2xl mb-1">{user.firstName} {user.lastName}</h3>
            ...
            <button className="flex flex-row gap-3 font-bold text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-2 focus:outline-none focus:ring-lime-200  font-medium rounded-lg text-sm px-12 py-3 text-center mr-1 mb-2">
              Edit
              <svg className="w-5 h-5 text-gray-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.109 17H1v-2a4 4 0 0 1 4-4h.87M10 4.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Zm7.95 2.55a2 2 0 0 1 0 2.829l-6.364 6.364-3.536.707.707-3.536 6.364-6.364a2 2 0 0 1 2.829 0Z"/>
            ...
            {showInput ? <> <div className="py-2 flex flex-col items-center  ">
                <div className="flex justify-center inline-flex my-3"><h3 className="text-center font-bold inline-flex text-xl mb-1">Are you sure you want to delete account and all data?</h3></div>
            ...
            <button onClick={handleCheckboxChange} className="flex flex-row gap-3 font-bold text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-2 focus:outline-none focus:ring-lime-200  font-medium rounded-lg text-sm px-12 py-3 text-center mr-1 mb-2">
              Cancel
